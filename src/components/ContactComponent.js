...
const requiered = (val) => val && val.length;
...
class Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        console.log("Current State is:" + this.props.feedback);
    }
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" id="firstname" name="firstname"
                                        ...
                                        validators={{
                                            requiered, minLength: minLength(3), maxLength: maxLength(15)
                                        }} />
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum"
                                        ...
                                        className="form-control"
                                        validators={{
                                            requiered, minLength: minLength(3), maxLength: maxLength(15), isNumber
                                        }} />
                                    <Errors className="text-danger"
                                        model=".telnum"
                                        show="touched"
